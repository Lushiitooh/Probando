...
pkmn.ditto = {
    ...
    hiddenAbility: ability.imposter,
    lore: `Se cree que es el resultado de un intento de replicar al ancestro de todos los Pokémon. El experimento no logró su objetivo, y la criatura que surgió fue considerada un fracaso.`
}
...
pkmn.articuno = {
    ...
    lore : `El frío del invierno. El aire se hiela y la escarcha se acumula a su paso. La nieve lo sigue, y las montañas quedan selladas bajo el hielo allí donde se detiene.`,
    eggMove : move.snowscape
}
...
pkmn.zapdos = {
    ...
    hiddenAbility: ability.dauntingLook,
    lore: `La tormenta del verano. El trueno retumba con su grito y los rayos caen al compás de sus alas. Los cielos se oscurecen a su paso, y violentas tormentas siguen su vuelo.`,
    eggMove : move.charge
}
...
pkmn.moltres = {
    ...
    hiddenAbility: ability.fieryPelt,
    lore : `El calor de la primavera. Su fuego no abrasa el mundo, sino que lo despierta, derritiendo la nieve y prendiendo vida nueva. El frío afloja su dominio a su paso, y la tierra se renueva con calor y luz.`,
...
pkmn.mewtwo = {
    ...
    lore: `Moldeado por manos humanas, carga con el peso de una creación torcida. Aunque lleva la memoria de la vida que le precedió, recorre un camino aparte, cuestionando los límites de su propia existencia.`
}
...
pkmn.mew = {
    ...
    lore: `El origen del que provienen todos los Pokémon tal y como los conocemos. Su forma, pequeña y apacible, guarda la memoria de cada criatura que vendría después.`
}
...
pkmn.celebi = {
    ...
    hiddenAbility: ability.grassySurge,
    lore: `Viajando a través del tiempo y apareciendo allí donde el pasado y el futuro se encuentran, preserva el orden natural y vela por que los ciclos de la vida, el crecimiento y las estaciones sigan sin interrupción.`
}
...
pkmn.kyogre = {
    ...
    hiddenAbility: ability.drizzle,
    lore: `Un recordatorio del poder que un día esculpió los mares. Su antigua rivalidad con Groudon perdura en silencio, un equilibrio escrito en la tierra y el agua.`
}
...
pkmn.kyogrePrimal = {
    ...
    lore: `Los océanos hechos visibles, y la fuerza que dio forma por primera vez a los mares del mundo. Las olas se alzan y las tormentas se reúnen a su voluntad.`
}
...
pkmn.groudon = {
    ...
    hiddenAbility: ability.drought,
    lore: `Un recordatorio del poder que un día esculpió las tierras. Su antigua rivalidad con Kyogre perdura en silencio, un equilibrio escrito en la tierra y el agua.`
...
pkmn.groudonPrimal = {
    ...
    lore: `Los continentes hechos uno, y la fuerza que dio forma por primera vez a la tierra del mundo. Las montañas se alzan y los desiertos se extienden a su voluntad.`
}
...
pkmn.rayquaza = {
    ...
    lore: `La fuerza que vela por el mundo desde las alturas. Templa el caos de los mares y la tierra, mediando entre Kyogre y Groudon. Los vientos y las corrientes obedecen su paso, y se yergue como guardián de los cielos.`
}
...
pkmn.megaRayquaza = {
    ...
    lore: `Ascendiendo por la atmósfera, su alcance se extiende hasta los cielos más altos. Protege no solo el mundo de abajo, sino también el espacio de arriba, guardándolo de amenazas venidas del más allá.`
}
...
pkmn.jirachi = {
    ...
    lore: `La encarnación del deseo, que despierta solo una vez cada mil años. En esos breves momentos escucha los anhelos que otros llevan en el corazón, y su poder los convierte en realidad.`
}
...
pkmn.uxie = {
    ...
    lore: `Surgió para dar forma al conocimiento. Cuando el mundo aún era nuevo, compartió el entendimiento con la humanidad y permitió que el pensamiento y la memoria arraigaran. Su presencia calma la agitación de los dioses del tiempo y el espacio.`
}
...
pkmn.mesprit = {
    ...
    hiddenAbility: ability.levitate,
    signature : move.mysticalPower,
    lore: `Surgió para dar forma a la emoción. Cuando el mundo aún era nuevo, compartió el sentimiento con la humanidad y permitió que la alegría, la tristeza y la empatía arraigaran. Su presencia sosiega la inquietud de los dioses del tiempo y el espacio.`
}
...
pkmn.azelf = {
    ...
    hiddenAbility: ability.prankster,
    signature : move.mysticalPower,
    lore: `Surgió para dar forma a la voluntad. Cuando el mundo aún era nuevo, concedió determinación a la humanidad y permitió que la acción, la elección y el empeño tomaran forma. Su presencia templa el espíritu de los dioses del tiempo y el espacio.`
}
...
pkmn.dialga = {
    ...
    lore: `Atado a un peso y un límite, una forma que el propio tiempo puede soportar. Su poder aún gobierna el pasado y el futuro, aunque contenido, pues el mundo no resistiría la medida completa de la eternidad hecha forma.`
}
...
pkmn.dialgaOrigin = {
    ...
    lore: `Moldeado por el Original cuando el universo aún no conocía su primer instante, fue traído para dar ley a la duración. Con su latido el tiempo empezó a fluir; con su voluntad, el pasado y el futuro se separaron y recibieron orden. Sin Él, toda la vida quedaría atrapada en una quietud eterna.`
}
...
pkmn.palkia = {
    ...
    hiddenAbility: ability.supremeOverlord,
    lore: `Atado a un peso y un límite, una forma que el propio espacio puede sostener. Su poder aún gobierna la distancia y la separación, aunque contenido, pues el mundo no soportaría el peso de una amplitud infinita hecha forma.`
}
...
pkmn.palkiaOrigin = {
    ...
    lore: `Moldeado por el Original cuando el universo aún no tenía medida, fue traído para dar forma a la extensión. Por su existencia, el espacio se hizo vasto; por su voluntad, la distancia cobró sentido. Sin Él, el mundo no tendría amplitud, ni separación entre el cielo y la tierra, ni camino alguno por el que la vida pudiera andar.`
}
...
pkmn.heatran = {
    ...
    lore: `Formado en las profundidades de la tierra, se mueve entre roca fundida y cavernas abrasadas, esculpiendo volcanes en el terreno mediante calor y presión.`
}
...
pkmn.regigigas = {
    ...
    lore: `Regigigas colocó los continentes en su sitio, arrastrando masas de tierra con cuerdas de roca y hielo y dando forma al mundo a pura fuerza. De esa labor nació el orden de la tierra, tras lo cual cayó en un largo letargo.`,
    hiddenAbility: ability.normalize,
...
pkmn.giratina = {
    ...
    lore: `Atado a un peso y un límite, una forma que la realidad puede tolerar. Su poder aún gobierna la antimateria y la oposición, aunque contenido, pues el mundo no resistiría la fuerza que deshace toda la creación hecha una.`
}
...
pkmn.giratinaOrigin = {
    ...
    lore: `Moldeado por el Original cuando las leyes de la creación tomaron forma por primera vez, nació desafiándolas. Con dominio sobre la antítesis de la materia, fue desterrado por su violencia y confinado a un mundo donde la lógica se derrumba y la dirección carece de sentido.`
}
...
pkmn.cresselia = {
    ...
    lore: `La encarnación de la luz de la luna. Desde las eras más antiguas vela por el sueño y los sueños, trayendo descanso apacible allí donde se acumula la oscuridad. Sus plumas disipan las pesadillas nacidas de Darkrai, y así equilibran el sosegado ritmo de la noche impreso en el mundo.`
}
...
pkmn.manaphy = {
    ...
    lore: `El príncipe de los mares, el elegido de los suyos, nacido con un vínculo que une a toda la vida del océano. Guía a las criaturas de las aguas y preserva la armonía bajo las olas.`,
    eggMove : move.tailGlow
}
...
pkmn.darkrai = {
    ...
    lore: `La encarnación de la sombra nocturna. Desde las eras más antiguas está ligada a los sueños, y saca a la luz el miedo y la inquietud allí donde permanece. Las pesadillas la siguen, no por voluntad propia, sino como reflejo de su naturaleza.`
}
...
pkmn.shaymin = {
    ...
    hiddenAbility: ability.verdify,
    lore: `Encarnando la gratitud y la renovación de la vida, recorre tierras yermas dejando campos de flores a su paso y devolviendo la vitalidad a la naturaleza, trayendo crecimiento y floración a lugares abandonados hace mucho.`
}
...
pkmn.arceus = {
    ...
    lore: `Surgido de la nada, la existencia fue creada con su nacimiento. Los pilares que gobiernan la realidad fueron moldeados por su voluntad y, aun así, esto no es más que un recipiente para que el ojo lo vea y la mente lo comprenda.`
}
...
pkmn.arceusFighting = {
    ...
    signature : move.judgment,
    lore: `Surgido de la nada, la existencia fue creada con su nacimiento, poniendo en marcha los hilos del universo. Los pilares que gobiernan la realidad fueron moldeados por sus mil brazos y, aun así, esto no es más que un recipiente, uno que la mente puede tolerar.`
}
...
ribbon.souvenir ={
    name: `Cinta Recuerdo`,
    description: `Se concede en ocasiones especiales`
}

ribbon.tower1 ={
    name: `Cinta Resistencia`,
    description: `Se concede por alcanzar la planta 30 de la Torre de Combate`
}

ribbon.smile ={
    name: `Cinta Sonrisa`,
    description: `Se concede muy rara vez por pasar mucho tiempo juntos`
}
