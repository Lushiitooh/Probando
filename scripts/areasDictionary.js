...
//positive
field.simpleAura = {
    info : function() { return `Todos tus Pokémon obtienen <strong data-ability="${ability.simple.id}" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("normal")}">${format(ability.simple.id)}</strong></strong>`},
    tier: 1
}

field.moodyAura = {
    info : function() { return `Todos tus Pokémon obtienen <strong data-ability="${ability.moody.id}" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("normal")}">${format(ability.simple.id)}</strong></strong>`},
    tier: 1
}

field.serendipity = {
    info : function() { return `Tus efectos al golpear tienen el doble de probabilidad`},
    tier: 1
}

field.harshSun = {
    info : function() { return `<strong data-buff="sunny" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("fire")}">Sol</strong></strong> permanente`},
    tier: 1
}

field.thickFog = {
    info : function() { return `<strong data-buff="foggy" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ghost")}">Niebla</strong></strong> permanente`},
    tier: 1
}

field.fierceHail = {
    info : function() { return `<strong data-buff="hail" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ice")}">Granizo</strong></strong> permanente`},
    tier: 1
}

field.coarseSandstorm = {
    info : function() { return `<strong data-buff="sandstorm" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ground")}">Tormenta de Arena</strong></strong> permanente`},
    tier: 1
}

field.heavyRain = {
    info : function() { return `<strong data-buff="rainy" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("water")}">Lluvia</strong></strong> permanente`},
    tier: 1
}

field.mistyField = {
    info : function() { return `<strong data-buff="mistyTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("psychic")}">Campo de Niebla</strong></strong> permanente`},
    tier: 1
}

field.grassyField = {
    info : function() { return `<strong data-buff="grassyTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("grass")}">Campo de Hierba</strong></strong> permanente`},
    tier: 1
}

field.electricField = {
    info : function() { return `<strong data-buff="electricTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("electric")}">Campo Eléctrico</strong></strong> permanente`},
    tier: 1
}
...
field.trickField = {
    info : function() { return `Los Pokémon lentos se vuelven rápidos y los rápidos, lentos`},
    tier: 2
}
 
field.reverseField = {
    info : function() { return `Las debilidades y resistencias de tipo se invierten`},
    tier: 2,
    chance: 0.5
}

field.averageTime = {
    info : function() { return `Todos los movimientos se ejecutan a la velocidad por defecto (2 s)`},
    tier: 2
}

field.noMercy = {
    info : function() { return `El daño al que se es inmune pasa a resistirse en vez de ignorarse`},
    tier: 2
}
...
field.deltaStream = {
    info : function() { return `Los cambios de clima están desactivados`},
    tier: 3
}

field.stealthRocks = {
    info : function() { return `Cambiar de Pokémon inflige daño`},
    tier: 3
}

field.heavyWeather = {
    info : function() { return `Si el tipo de un Pokémon activo de tu equipo no coincide con el clima actual, recibe daño periódico`},
    tier: 3
}

field.ironBody = {
    info : function() { return `El daño supereficaz sobre el Pokémon enemigo se reduce a neutro`},
    tier: 3
}
...
field.wonderWard = {
    info : function() { return `El daño no supereficaz infligido al enemigo se reduce un 80%`},
    tier: 4
}

field.neutralisingGas = {
    info : function() { return `Las habilidades están desactivadas`},
    tier: 4
}


field.weakeningCurse = {
    info : function() { return `El daño físico infligido al enemigo se reduce a la mitad`},
    tier: 4
}

field.fatiguingCurse = {
    info : function() { return `El daño especial infligido al enemigo se reduce a la mitad`},
    tier: 4
}

field.unnerve = {
    info : function() { return `Los objetos están desactivados`},
    tier: 4
}
...
field.firePledge = {
    info : function() { return `Los Pokémon que no sean de tipo Fuego no pueden participar`},
    tier: 4,
    chance: 0
}

field.fightingPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Lucha no pueden participar`},
    tier: 4,
    chance: 0
}

field.darkPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Siniestro no pueden participar`},
    tier: 4,
    chance: 0
}

field.dragonPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Dragón no pueden participar`},
    tier: 4,
    chance: 0
}

field.fairyPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Hada no pueden participar`},
    tier: 4,
    chance: 0
}

field.rockPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Roca no pueden participar`},
    tier: 4,
    chance: 0
}

field.electricPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Eléctrico no pueden participar`},
    tier: 4,
    chance: 0
}

field.steelPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Acero no pueden participar`},
    tier: 4,
    chance: 0
}

field.grassPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Planta no pueden participar`},
    tier: 4,
    chance: 0
}

field.waterPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Agua no pueden participar`},
    tier: 4,
    chance: 0
}

field.IcePledge = {
    info : function() { return `Los Pokémon que no sean de tipo Hielo no pueden participar`},
    tier: 4,
    chance: 0
}

field.poisonPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Veneno no pueden participar`},
    tier: 4,
    chance: 0
}

field.flyingPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Volador no pueden participar`},
    tier: 4,
    chance: 0
}

field.normalPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Normal no pueden participar`},
    tier: 4,
    chance: 0
}

field.bugPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Bicho no pueden participar`},
    tier: 4,
    chance: 0
}

field.groundPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Tierra no pueden participar`},
    tier: 4,
    chance: 0
}

field.ghostPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Fantasma no pueden participar`},
    tier: 4,
    chance: 0
}

field.psychicPledge = {
    info : function() { return `Los Pokémon que no sean de tipo Psíquico no pueden participar`},
    tier: 4,
    chance: 0
}
...
skill.ironWill = {
    info : function() { return `Aumenta la Defensa un 100% durante 15 turnos`},
    effect : function () { moveBuff("wild","defup2",undefined,15) }
}

skill.ironSpirit = {
    info : function() { return `Aumenta la Defensa Especial un 100% durante 15 turnos`},
    effect : function () { moveBuff("wild","sdefup2",undefined,15) }
}

skill.omniboost = {
    info : function() { return `Aumenta todas las características un 50% durante 10 turnos`},
...
skill.electroblast = {
    info : function() { return `Inflige ${tagParalysis} a todo tu equipo durante 10 turnos`},
    effect : function () { moveBuff("wild",'paralysis',"team",10) }
}

skill.pyroblast = {
    info : function() { return `Inflige ${tagBurn} a todo tu equipo durante 15 turnos`},
    effect : function () { moveBuff("wild",'burn',"team",15) }
}

skill.cryoblast = {
    info : function() { return `Inflige ${tagFreeze} a todo tu equipo durante 10 turnos`},
    effect : function () { moveBuff("wild",'freeze',"team",15) }
}

skill.toxiblast = {
    info : function() { return `Inflige ${tagPoisoned} a todo tu equipo durante 15 turnos`},
...
skill.suddenDeath = {
    info : function() { return `Debilita a tu Pokémon activo`},
    effect : function () { pkmn[ team[exploreActiveMember].pkmn.id ].playerHp = 0; updateTeamPkmn() }
}

skill.demoralisingRoar = {
    info : function() { return `Elimina todas las mejoras del equipo`},
    effect : function () {
...
areas.sinnohUndergroundI = {
    ...
    background : `cave`,
    level : wildAreaLevel2,
    unlockDescription : `Derrota al Líder de Gimnasio Brock en VS para desbloquear`,
...
areas.advancedDojoI = {
    ...
    type: `dungeon`,
    background : `gym`,
    unlockDescription : `Derrota al Líder de Gimnasio Misty en VS para desbloquear`,
...
areas.expertDojoI = {
    ...
    type: `dungeon`,
    background : `gym`,
    unlockDescription : `Derrota al Líder de Gimnasio Phoebe en VS para desbloquear`,
...
areas.victoryRoadI = {
    ...
    unlockDescription : `Derrota a la Entrenadora de Élite Cynthia en VS para desbloquear`,
...
areas.glisteringCaveI = {
    ...
    level : 95,
    difficulty: 5,
    unlockDescription : `Derrota a la Entidad Ultra Lusamine en VS para desbloquear`,
...
areas.sunkenTempleI = {
    ...
    level : 100,
    difficulty: 5,
    unlockDescription : `Derrota al Profesor Pokémon Oak en VS para desbloquear`,
...
areas.ceruleanCave = {
    ...
    difficulty: 5,
    uncatchable: true,
    unlockDescription : `Derrota a la Entrenadora Maestra Geeta en VS para desbloquear`,
...
areas.vsGymLeaderBrock = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipTitle").innerHTML = `¡Nuevas funciones desbloqueadas!`
        document.getElementById("tooltipBottom").style.display = `none`
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Nueva Zona Salvaje desbloqueada</div>
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Subsuelo de Sinnoh</div>
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Dojo Principiante</div>
        <div style="filter:hue-rotate(50deg)" >Regalo Misterioso desbloqueado</div>
        <div style="filter:hue-rotate(200deg)" >Recompensa de Exportación desbloqueada</div>
        <div style="filter:hue-rotate(300deg)" >Poké Tienda desbloqueada</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsGymLeaderMisty = {
    ...
    encounterEffect: function() {
        ...
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Nueva Zona Salvaje desbloqueada</div>
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Dojo Avanzado</div>
        <div style="filter:hue-rotate(300deg)" >Entrenamiento desbloqueado</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsGymLeaderPhoebe = {
    ...
    encounterEffect: function() {
        ...
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Nueva Zona Salvaje desbloqueada</div>
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Dojo Experto</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsEliteTrainerCynthia = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Incursiones de Evento Nivel I desbloqueadas</div>
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Calle Victoria</div>
        <div style="filter:hue-rotate(50deg)" >Entrenamiento de nivel desbloqueado</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsEliteFourLance = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Incursiones de Evento Nivel II desbloqueadas</div>
        <div style="filter:hue-rotate(0deg)" >Genética desbloqueada</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsTeamLeaderGiovanni = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(0deg)" >Frontera de Combate desbloqueada</div>
        <div style="filter:hue-rotate(100deg)" >Pestaña de Eventos Élite desbloqueada</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsMasterTrainerGeeta = {
    ...
    itemReward: { 1 : { item: item.autoRefightTicket.id, amount: 3 }, 2 : { item: item.bottleCap.id, amount: 10 }},
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Incursiones de Evento Nivel III desbloqueadas</div>
        <div style="filter:hue-rotate(200deg)" >Intercambio Milagroso desbloqueado</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsUltraEntityLusamine = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >Incursiones de Evento Nivel IV desbloqueadas</div>
        <div style="filter:hue-rotate(300deg)" >La Liga Maestra ya está disponible en la Frontera de Combate</div>
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Cueva Reluciente</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsLegendTrainerBrendan = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(100deg)" >El canje de Bonguris ya está disponible en la Poké Tienda</div>
        <div style="filter:hue-rotate(300deg)" >El Restaurante ya está disponible en la Poké Tienda</div>
        <div style="filter:hue-rotate(200deg)" >Megadimensión desbloqueada</div>
        <div style="filter:hue-rotate(50deg)" >Entrenamiento de naturaleza desbloqueado</div>
        </div>
        `
        openTooltip()
    }
...
areas.vsPokemonProfessorOak = {
    ...
    encounterEffect: function() {
        ...
        document.getElementById("tooltipMid").innerHTML = `
        <div class="genetics-overview-tags" >
        <div style="filter:hue-rotate(0deg)" >Nueva mazmorra: Templo Sumergido</div>
        </div>
        `
        openTooltip()
    }
...
for (const i in areas){
    ...
    if (areas[i].type == "wild" && areas[i].level == wildAreaLevel2) {
        areas[i].unlockDescription = `Derrota al Líder de Gimnasio Brock en VS para desbloquear`
    ...
    if (areas[i].type == "wild" && areas[i].level == wildAreaLevel3) {
        areas[i].unlockDescription = `Derrota al Líder de Gimnasio Misty en VS para desbloquear`
    ...
    if (areas[i].type == "wild" && areas[i].level == wildAreaLevel4) {
        areas[i].unlockDescription = `Derrota al Líder de Gimnasio Phoebe en VS para desbloquear`
