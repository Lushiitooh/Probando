...
(function () {
  ...
  function handleDuplicate(targetKey) {
    ...
    if (!targetKey || targetKey === currentKey) {
      ...
      tooltipMid.innerHTML = "Elige otra ranura de equipo.";
      return;
    }
  ...
  function showDuplicateConfirm(targetKey) {
    ...
    document.getElementById("tooltipTitle").innerHTML = "¿Sobrescribir equipo?";
    document.getElementById("tooltipMid").innerHTML = `Esto reemplazará ${getTeamName(targetKey)}.`;
  ...
  function openDuplicateTeamMenu() {
    ...
    document.getElementById("tooltipTop").style.display = "none";
    document.getElementById("tooltipTitle").innerHTML = "Copiar equipo"; //PR-EDIT
    document.getElementById("tooltipMid").innerHTML = "Elige la ranura de equipo que quieres sobrescribir.";
    ...
    duplicateButton.textContent = "Duplicar equipo";
  ...
  function initDuplicateTeamButton() {
    ...
    button.setAttribute("title", "Duplicar equipo");
