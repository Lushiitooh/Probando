...
function updatePreviewTeam(){
    ...
    div.innerHTML = `
        ...
        <div class="explore-header-infobox">
        <div class="explore-header-hpbox">
        <span style="color: white;">Añadir Pokémon</span>
        </div>
        <div class="explore-header-moves" id="explore-team-member-${i}-moves-preview">
        </div>
        </div>
...
function editTeamName(){
    ...
    document.getElementById("tooltipTitle").innerHTML = "Editar nombre del equipo"
...
function injectPreviewTeam(){
    ...
    if (frontierError) {
        document.getElementById("tooltipTop").style.display = "none"
        document.getElementById("tooltipBottom").style.display = "none"
        document.getElementById("tooltipTitle").innerHTML = `Pokémon prohibidos`
        document.getElementById("tooltipMid").innerHTML = `Uno o más Pokémon del equipo no cumplen las restricciones de división de la liga actual`
        openTooltip()
        return
    }
    ...
    if (nuzlockeError) {
        document.getElementById("tooltipTop").style.display = "none"
        document.getElementById("tooltipBottom").style.display = "none"
        document.getElementById("tooltipTitle").innerHTML = `Pokémon restringidos`
        document.getElementById("tooltipMid").innerHTML = `Uno o más Pokémon del equipo no se pueden usar por las restricciones Nuzlocke`
        openTooltip()
        return
    }
    ...
    if (restrictedError) {
        ...
        document.getElementById("tooltipMid").innerHTML = `Uno o más Pokémon del equipo tienen varios movimientos restringidos (${restrictedIcon}) equipped`
        openTooltip()
        return
    }
    ...
    if (zCrystalError>1) {
        document.getElementById("tooltipTop").style.display = "none"
        document.getElementById("tooltipBottom").style.display = "none"
        document.getElementById("tooltipTitle").innerHTML = `Movimientos Z restringidos`
        document.getElementById("tooltipMid").innerHTML = `No se pueden equipar varios cristales Z en un mismo equipo`
        openTooltip()
        return
    }
    ...
    if (batonPassError) {
        document.getElementById("tooltipTop").style.display = "none"
        document.getElementById("tooltipBottom").style.display = "none"
        document.getElementById("tooltipTitle").innerHTML = `Cláusula de Relevo`
        document.getElementById("tooltipMid").innerHTML = `Solo puedes tener un Relevo en tu equipo`
        openTooltip()
        return
    }
    ...
    if (eggMoveError) {
        document.getElementById("tooltipTop").style.display = "none"
        document.getElementById("tooltipBottom").style.display = "none"
        document.getElementById("tooltipTitle").innerHTML = `Movimientos de huevo repetidos`
        document.getElementById("tooltipMid").innerHTML = `No puede haber varios movimientos de huevo iguales en el mismo equipo si el anfitrión no tiene dicho movimiento como movimiento de huevo propio o movimiento firma`
        openTooltip()
        return
    }
    ...
    if (pkmn[currentTeam.slot1.pkmn]===undefined){
        ...
        document.getElementById("tooltipBottom").innerHTML = "¡La primera ranura del equipo no puede estar vacía!"
        openTooltip()
        return
    }
